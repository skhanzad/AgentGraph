...
def get_pipeline_graph():
    ...
    edges = [
        ...
        ("planner", "coder", None),
        ("coder", "docker_tester", "docker_test_phase"),
        ("coder", "coder", "more tasks"),
        ("coder", "reviewer", "all done"),
        ("reviewer", "tester", "approved"),
        ("reviewer", "coder", "rework"),
        ("tester", "docs", "passed"),
        ("tester", "debugger", "failed"),
        ("debugger", "coder", None),
        ("docs", "devops", None),
        ("devops", "docker_tester", None),
        ("docker_tester", "__end__", "passed"),
        ("docker_tester", "debugger", "failed"),
    ]
    return nodes, edges
